...
def main():
    ...
    try:
        ...
        core.create_or_update_from_yaml(
            yaml_file_path=".agent-engine.yml", profile="development", dry_run=True
        )
        print("Development profile loaded successfully!")

        # Example 3: Using production profile
        core.create_or_update_from_yaml(
            yaml_file_path=".agent-engine.yml", profile="production", dry_run=True
        )
